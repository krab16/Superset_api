...
INPUT_DIR = "C:\\Users\\USER\\Desktop\\ss_api\\dashb" # work directory
...
db_dev_link = 'postgresql://USER_dev:PASS@HOST:PORT/SHEMA_DEV'
db_uat_link = 'postgresql://USER_uat:PASS@HOST:POSRT/SHEMA_UAT'
db_name = 'db_name'
ds_dev = 'PRAVDA2_DEV'
ds_uat = 'PRAVDA2_UAT'
rms_dev = "we250d" ## For edit link - specific funct for project
rms_uat = "we260u"  ## For edit link - specific funct for project
        ...
        with zipfile.ZipFile(os.path.join(INPUT_DIR, file_name), 'r') as zip_ref:
            ...
            if os.path.exists(dash_path):
                for i in range(0, len(files_dash)): # delete CSS
                    ...
                    re_dash = re.sub(r'css:.*?slug:', "css: 'body{background-color:white;white-space: nowrap;}'\nslug:", inp_dash, flags=re.DOTALL)                    
            ...
            if os.path.exists(ds_path):
                ...
                for i in range(0, len(files_ds)):
                    ...
                    dataset_edit = dataset_edit.replace(ds_dev, ds_uat) #change catalog
                    dataset_edit = dataset_edit.replace(rms_dev, rms_uat) #change RMS link
